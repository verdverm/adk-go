# ADK Internal HTTP Record and Replay Components (`internal/httprr/`)
...
*   **Licensing**: The code is derived from The Go Authors and is under a BSD-style license, distinct from the main ADK Apache 2.0 license.